...
for k = 1:m
    ...
    str = sprintf('APPROXIMATE SOLUTION (%s), component %i', method, k);  % Create legend string
    ...
    if (ex == 1)
        ...
        str1 = sprintf('APPROXIMATE SOLUTION (%s), component %i', method, k);  % Legend for approx solution
